...
#define PSLAB_PICO_MAX_CAPTURE_WORDS \
    (PSLAB_PICO_MAX_SAMPLES / (32u / PSLAB_PICO_MAX_CHANNELS))
#define PSLAB_PICO_MAX_BLOCK_BYTES \
    (PSLAB_PICO_MAX_CAPTURE_WORDS * sizeof(uint32_t))
