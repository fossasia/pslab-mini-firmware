...
void setUp(void)
{
    ...
    test_uart_handle = UART_init(UART_BUS_0, &rx_buffer, &tx_buffer);
...
void test_syscalls_init_already_initialized(void)
{
    ...
    UART_Handle *another_handle = UART_init(UART_BUS_1, &rx_buffer2, &tx_buffer2);
...
void test_syscalls_deinit_wrong_handle(void)
{
    ...
    UART_Handle *wrong_handle = UART_init(UART_BUS_1, &rx_buffer3, &tx_buffer3);
